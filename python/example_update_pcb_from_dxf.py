...
if __name__ == "__main__":
    ...
    # ================= USER INPUTS ==================
    dxf_filename = 'EMG-sleeve-forearm_128ch_V8.DXF' # DFX file name with shape data
    pcb_filename = '128ch-hdemg-forearm.kicad_pcb' # kicad_pcb file name to update

    # Define some metadata in the PCB file like footprint, radius, and entity type
    pcb_data = {
        ...
        'm3-mount': {'footprint': 'MountingHole:MountingHole_3.2mm_M3_Pad_TopOnly', 'radius': 1.5, 'entity': 'CIRCLE'},
    }
    ...
    results = KiCadUtils.get_coordinates_from_dxf(dxf_filepath, pcb_data, visualize=True)

    # Apply remapping of specific footprint coordinates, use PCB schematic style to center the design
    offset = kicad_pcb_schematic[style]
    remapped_df = KiCadUtils.apply_remapping_v2(results, 'forearm-pattern', shape_key, offset, flip_y, True)
